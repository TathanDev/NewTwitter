...
export default function ModernPost({ post, isDetailView = false, onCommentsCountChange, externalCommentsCount }) {
  ...
  const handleBookmark = async (e) => {
    ...
    try {
      ...
      console.log(`${result.isFavorite ? "Ajouté aux" : "Retiré des"} favoris: post ${post.post_id}`);
    } catch (error) {
      // Rollback en cas d'erreur
  ...
  // Debug: afficher la structure du contenu
  console.log('Post content structure:', post.content_structure);
